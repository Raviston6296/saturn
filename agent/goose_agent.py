...
class GooseAgent:
    ...
    def _build_rich_prompt(self, task: str, files_changed: list[str]) -> str:
        ...
        sections.append(
            ...
            "3g. This ZDPAS Project don't have any predefined auto discoverable libs to compile read gates/config.py -> _get_zdpas_gates and run affected module suites if needed"
            "## Repo Rules\n"
